    ...
    <div className={styles.overlay}>
      ...
      >
        <header className={styles.header}>
          ...
          <div className={styles.headerControls}>
            <button
              ...
              aria-label="Concentrează câmpul contului personal"
            >
        ...
        <div className={styles.content}>
          <h2 id="personal-account-title" className={styles.title}>
            INTRĂ ÎN
            <br />
            CONTUL PERSONAL
          </h2>
          <p className={styles.description}>
            Plăți, documente și mesaje cu echipa — totul într-un singur loc.
          </p>
          ...
          <form className={styles.form} onSubmit={handleSubmit}>
            ...
            <label className={styles.visuallyHidden} htmlFor="account-identifier">
            ...
            <input
              ...
              inputMode="email"
              placeholder="E-mail sau nume de utilizator"
              value={identifier}
